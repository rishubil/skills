---
title: Introduction - Meta Box Documentation
source: https://docs.metabox.io/introduction/
version: 5.12.0
fetched: 2026-05-11
---
...
Meta Box provides powerful features [via extensions](extensions/index.md) such as front-end form submission, creating post relationships, saving data in custom tables, toggling fields with conditional logic, creating Gutenberg blocks, and many integrations with 3rd-party plugins.
...
Learn more about [Meta Box philosophy](philosophy.md).

## Meta Box overview

Meta Box has 3 versions:

- **Meta Box**: the foundation and framework of all [extensions](extensions/index.md) and features. Then, you can add individual extensions (free or premium) to have advanced features. It doesn't have any UI, and is suitable for developers only, who need to use code to use it.
- [**Meta Box Lite**](https://metabox.io/lite/): a single free UI version of Meta Box that includes the Meta Box plugin, [MB Builder](extensions/meta-box-builder.md), and all the free extensions to create custom post types, custom taxonomies, custom fields, relationships.
...
Now you know about Meta Box, let's [start using it](installation.md)!
