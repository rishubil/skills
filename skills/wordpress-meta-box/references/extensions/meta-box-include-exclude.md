---
title: MB Include Exclude - Meta Box Documentation
source: https://docs.metabox.io/extensions/meta-box-include-exclude/
---
...
| `edited_user_role` | Role of the being edited user. Works on the user profile or user edit screens only. Requires [MB User Meta](https://docs.metabox.io/extensions/mb-user-meta/) extension. |
| `edited_user_id` | User ID of the being edited user. Works on the user profile or user edit screens only. Requires [MB User Meta](https://docs.metabox.io/extensions/mb-user-meta/) extension. |
