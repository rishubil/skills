...
![Show as an admin column settings](https://docs.metabox.io/assets/images/admin-columns-option-9b2e5ad5c14ed2e9aa3f46d0e6da0f3f.png)

More settings will appear below that let you customize the admin column for that field:

![Admin columns settings](https://docs.metabox.io/assets/images/customize-settings-980bc2936e53dec285c49496e2703e15.png)
