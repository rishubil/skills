---
title: Adding related posts using custom fields - Meta Box Documentation
source: https://docs.metabox.io/tutorials/add-related-posts/
---
...
![This is a typical section for related posts](https://imgur.elightup.com/VtkA5bQ.png)
...
![Go to Meta Box > Custom Fields > Add New to create fields](https://imgur.elightup.com/Xsbr0l7.png)

Add the field in the type of **Post**. This field type allows you to choose a/multiple posts from a regulated post type.

![Add Post field to choose a/multiple posts from a regulated post type](https://imgur.elightup.com/9zJlC5B.png)

You should configure this field a little bit.

![You should configure Label description, Post types and Field type field.](https://imgur.elightup.com/0fiGpOG.png)
...
![Turn on the Multiple option to allow users to add more than related posts.](https://imgur.elightup.com/0VcIohi.png)
...
![move to the Settings tab, set Location as Post type, then choose a post type of the post where you want to show related posts](https://imgur.elightup.com/Mq0QoOF.png)

Back to the post editor of your post type, you will see the created field.

![Here is the created field.](https://imgur.elightup.com/zNfwGac.png)
...
![Choose some posts from the list Related Posts](https://imgur.elightup.com/gtGL6vB.png)
...
![Go to Views in Meta Box and create a new view.](https://imgur.elightup.com/R6GiiOF.png)

In the **Template** tab of the view, click on the **Insert Field** button. Look for the created field for related posts.

![Click on the Insert Field button and look for the created field for related posts.](https://imgur.elightup.com/Wh48Z3W.png)
...
![Choose Post Thumbnail, Post Title and Post Content respectively to show the information about related posts on the singular page.](https://imgur.elightup.com/98dDUXk.png)
...
![The code with syntax added to the template](https://imgur.elightup.com/7YTqm2z.png)
...
![Go down to the Settings section of the view, set the Type as Singular](https://imgur.elightup.com/aw8dSZe.png)

And choose the location as the singular of your post type.

![Choose the location as the singular of post type.](https://imgur.elightup.com/NZcsmpK.png)
...
![Here is related posts before styling](https://imgur.elightup.com/nb0p735.png)
...
![Add some div tags and classes for each information to have a better look](https://imgur.elightup.com/xGBbYm4.png)

You also can add heading, hyperlink, etc. Then, move to the **CSS** tab and add some code.

![Add some code in CSS tab](https://imgur.elightup.com/44JM83H.png)

And this is the result.

![This is the result of related posts.](https://imgur.elightup.com/INGfIz9.png)
...
![Go to the single.php or single-custom_post_type_slug.php file and put some code.](https://imgur.elightup.com/Anm3MKX.png)
...
![Title of the posts displayed in the singular page](https://imgur.elightup.com/L7YOk4t.png)
...
![Add some div tag, classes, heading, etc. as to the code in the theme’s file](https://imgur.elightup.com/wGX3r6B.png)

Then add CSS to the single page via Customizer or theme’s file. Then, you will have a new look of the section.

![This is the result of a typical section for related posts](https://imgur.elightup.com/INGfIz9.png)
