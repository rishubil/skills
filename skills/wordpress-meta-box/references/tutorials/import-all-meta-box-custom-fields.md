...
This is used when each data piece is stored in its own column, i.e., using separate elements. For example, if you have a cloneable field containing a link, and your CSV file has five columns – url\_one, url\_two, url\_three, etc:
