...
![In the New User Default Role section, you can choose to set the default role when they register.](https://imgur.elightup.com/SD8j3iQ.png)
...
![Change the label of the button](https://imgur.elightup.com/53Cli8E.png)
