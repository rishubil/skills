---
title: Creating a custom 404 page in WordPress - Meta Box + Oxygen - Meta Box Documentation
source: https://docs.metabox.io/tutorials/create-custom-404-page-with-oxygen/
---
...
![The custom 404 page was built by Meta Box and Oxygen.](https://imgur.elightup.com/rH5v9zL.png)
...
![The page is in the Settings menu, it’s still blank](https://imgur.elightup.com/LtKOXWn.png)
...
![Some fields that I’ll create for the page as examples](https://imgur.elightup.com/a2UeSdk.png)
...
![Add the subfields for the label and URL of the button](https://imgur.elightup.com/CijbDF4.png)

In my specific case, I set the group as collapsible and named it for the button.

![Set the name of the button](https://imgur.elightup.com/oQemLrc.png)

If you want to add more than one button, make the group cloneable by enabling the corresponding option.

![Set the group is clonable to add more than one button](https://imgur.elightup.com/vtoIV1A.png)
...
![In the Settings tab, set the Location and choose the created settings page to apply the fields to it.](https://imgur.elightup.com/bveviUt.png)
...
![Add new template with Oxygen](https://imgur.elightup.com/DMyy9Go.png)

And, choose any option to inherit its design.

![Choose any option to inherit its design.](https://imgur.elightup.com/IQeXq99.png)

Oxygen supports a specific template for 404 page. Just choose that option.

![Oxygen supports a specific template for 404 page.](https://imgur.elightup.com/bNDZcgA.png)
...
![Add a new section](https://imgur.elightup.com/z0rXPdi.png)

Then, I add a **Column** component and choose the suitable layout.

![Add a Column component and choose the suitable layout](https://imgur.elightup.com/ih5yHfL.png)
...
![Choose Image component for the image](https://imgur.elightup.com/1TLWZX2.png)
...
![Get the image](https://imgur.elightup.com/U6kcGqB.gif)
...
![Add a Text component for the message](https://imgur.elightup.com/5ISpaNB.png)
...
![Choose the Meta Box Field option, and select the message field.](https://imgur.elightup.com/Aflc2x0.gif)
...
![Add a Code Block component, go to the PHP & HTML section.)](https://imgur.elightup.com/0N2Hgon.png)

![Add some code in the PHP & HTML section](https://imgur.elightup.com/SBIYNX1.png)
...
![The data is displayed all. But, the button is in text format.](https://imgur.elightup.com/wVyeVR0.png)
...
![Change some settings of each component to have the desired look.](https://imgur.elightup.com/82E6XHN.png)

In the **Code Block** where I display the button, I add some div tags and classes, then modify it a little bit.

![In the Code Block where I display the button, I add some div tags and classes](https://imgur.elightup.com/Etzm2gv.png)
...
![Use CSS to style the button](https://imgur.elightup.com/UH99k5E.png)
...
![Go back to the settings page, and change the content in the custom fields.](https://imgur.elightup.com/yp5hyV0.png)

Then, you’ll have a 404 page with the new content. It’s more convenient for management.

![A 404 page with the new content](https://imgur.elightup.com/DMYMmiB.png)
