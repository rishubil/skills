...
![Create a Settings Page](https://imgur.elightup.com/xj8IOWJ.png)

Now, a new menu named **Brands** appears. It’s my new **Settings Page**.

![The new Settings Page named Brands appears.](https://imgur.elightup.com/U4H4ELu.png)
...
| Brand Logo Url | Url | brand\_logo\_url |
...
![Set this group as cloneable to have more spaces to add different brands information.](https://imgur.elightup.com/Hi033mY.png)
...
![2 fields which are Single Image and Url help you upload images and input a link of image.](https://imgur.elightup.com/dmaPInv.png)
...
![In the Settings tab, choose the Location as the Settings Page that we’ve just created to apply the custom fields.](https://imgur.elightup.com/MHr0exH.png)
...
![The created custom fields are displayed.](https://imgur.elightup.com/4JJ0nEh.png)
...
![In the Template tab, you can insert fields to get their data.](https://imgur.elightup.com/2aD8XWb.png)

Since we created custom fields for the **Settings Page**, we go to the **Site** tab then find the created custom fields.

![In Site tab, find the custom fields that I created for the Settings Page](https://imgur.elightup.com/mJIBoAZ.png)

Because this group is cloneable so whenever you open the group here to find any field, it will auto-generate a Loop.

![A Loop is auto generated whenever you open the group to find any field](https://imgur.elightup.com/SLlnKl4.png)

Delete the text ‘INSERT SUB-FIELDS HERE” and choose a field from the list in the sidebar to add a field inside the loop.

![choose a field from the list in the sidebar to add a field inside the loop](https://imgur.elightup.com/HPXAk4U.gif)

When you insert the logo from the **Single Image** field, you can choose the size to output. Here I set it to be the thumbnail.

![Get the value from the Single Image field when the URL field is empty](https://imgur.elightup.com/A9VwBOb.png)
...
![Get the value from the Single Image field](https://imgur.elightup.com/ndDjfEa.png)
...
![The following code will stipulate that if there is no input data](https://imgur.elightup.com/Xro7EVw.png)
...
![If there is data set priority to display image](https://imgur.elightup.com/2YUI1Vy.png)
...
![Remember to insert the added information in the text line](https://imgur.elightup.com/m4VWKZB.png)
...
![choose the type of view as shortcode](https://imgur.elightup.com/nEOIWFM.png)
...
![All the images appeared](https://imgur.elightup.com/mTWu5xF.gif)

## 4\. Styling the section

In the view, move to the **CSS** tab and add css into the box.

![Add Css code to the box](https://imgur.elightup.com/hUni7yc.png)
...
![The result after adding css code](https://imgur.elightup.com/MQpnntm.png)
