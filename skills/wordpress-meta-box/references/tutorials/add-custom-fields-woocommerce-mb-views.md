...
The fields are in the backend so far. If you want to display data saved in the fields on the product page, you should use a hook provided by WooCommerce: 'woocommerce\_product\_meta\_end'.
...
Set the **Type** of the view as **Action**. In the **Action name** box, as ***'woocommerce\_product\_meta\_end'*** which is the name of the hook. You can read more about this hook in WooCommerce documentation for more details.
