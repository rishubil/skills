...
![Display booking form on the frontend.](https://docs.metabox.io/assets/images/display-booking-form-frontend-97b13902537e05b64d0d2727b2525a17.gif)
...
![All rooms](https://docs.metabox.io/assets/images/all-rooms-b916b874085e6a80d50b7365694fe786.png)
...
![create template with mbviews](https://docs.metabox.io/assets/images/create-template-mbviews-2f8721fcbdfe8aed948d3a5304fec63d.png)

Now, you can insert custom fields from the room group field or directly write code in the **Template** section.

![insert filed and add code to template](https://docs.metabox.io/assets/images/insert-fields-and-add-codes-b711cddfaeb92b0b3480297507325b72.png)
...
![set template location](https://docs.metabox.io/assets/images/set-template-location-e27e0affb9696276a9aa9ad6f45a1f1d.png)

Now you can see that the single room page displays all the room’s information.

![single room](https://docs.metabox.io/assets/images/single-room-9278e8650320c25c9ee2795711f005aa.png)
...
![Check out the page I made as an example for usersbooking form with no functionality](https://docs.metabox.io/assets/images/booking-form-no-functionality-feb97a272b6ca62a0062c96a7022b513.gif)

However, some fields are unnecessary for customers, so we can add **CSS classes** to hide those fields.

![Remove fields](https://docs.metabox.io/assets/images/remove-fields-e780585cafcd2c02658cb7cd735ca32e.png)
...
![customizer](https://docs.metabox.io/assets/images/customizer-16a58fd3a1bc7138912c0c1ebe5c9c54.png)
...
![function doesn’t work](https://docs.metabox.io/assets/images/function-not-work-eb5709433f0578e9a0928f23ac57cc03.gif)
...
![function work well](https://docs.metabox.io/assets/images/functions-work-well-72ec68a11de2a630c95a28c6543bdee6.gif)
