...
![Example of displaying the most viewed posts](https://imgur.elightup.com/shVpLBQ.png)
...
![Create a new custom post type](https://imgur.elightup.com/TB2fB1v.png)

## 2\. Creating custom fields

Go to **Meta Box** > **Custom Fields** and create custom fields to save the extra information for the post.

![Create custom fields](https://imgur.elightup.com/T0zQrP1.png)
...
![Set location for the created custom fields](https://imgur.elightup.com/iPANEBR.png)

In the post editor, you will see all of the created custom fields.

![All created custom fields appear in the post editor](https://imgur.elightup.com/zGjKu27.png)
...
![Add a column of information about the posts viewed ](https://imgur.elightup.com/68M4JZg.png)
...
![Settings for the WP Post Views plugin](https://imgur.elightup.com/xC3DgV0.png)

Go back to the list of posts, and you will see the new column appear.

![A column of the posts view](https://imgur.elightup.com/j8rEgaf.png)
...
![Select the Section element to have the section that shows the most viewed posts](https://imgur.elightup.com/EZVHwCH.png)

Next, add a **Heading** element and name the title.

![Add a Heading element and name the title](https://imgur.elightup.com/c9yVS74.png)

In the **Container** element inside the section, select the **Div** element to contain the restaurant’s information.

![Select the Div element to contain the restaurant’s information.](https://imgur.elightup.com/rvvOYHT.png)
...
![Get the data of restaurants](https://imgur.elightup.com/5wBt9WP.png)
...
![Choose the Meta numeric value option to get the value in numeric](https://imgur.elightup.com/ixiR9gy.png)

Move to the **Order meta key** section to fill in `entry_views`, which is generated by **WP Post Views**, to filter the wanted posts.

![In the Order meta key section to fill in entry_views to filter the wanted posts.](https://imgur.elightup.com/nMS6zg4.png)
...
![Select the Descending option to sort the posts in order from the most viewed posts to the fewer viewed posts.](https://imgur.elightup.com/GcHlkGK.png)
...
![Set the number of posts you want to show in the Post per page section.](https://imgur.elightup.com/o6pZ9P1.png)
...
![Select the Image element to display the image of the restaurant.](https://imgur.elightup.com/ufh9vpS.png)

Then, click the **Select** dynamic data icon and choose the **Featured Image** option.

![Choose the Featured Image option](https://imgur.elightup.com/ytk9w81.png)

As you can see, the image is displayed in the preview.

![The image is displayed in the preview](https://imgur.elightup.com/PY14iBr.png)
...
![Get the voucher information](https://imgur.elightup.com/ZHlAeOZ.gif)
...
![Get the address information](https://imgur.elightup.com/e05xHBd.png)
...
![Get the restaurant's logo](https://imgur.elightup.com/Jht3oeJ.png)
...
![On the frontend, all the most viewed restaurant information is displayed.](https://imgur.elightup.com/rACjA5A.png)
...
![Add some CSS to have a more advanced style](https://imgur.elightup.com/vOlBj8y.png)

Go to the homepage, all the featured restaurants are displayed as we want.

![All the most viewed restaurants are displayed as we want](https://imgur.elightup.com/shVpLBQ.png)
