---
title: Migrating from ACF to Meta Box - Meta Box Documentation
source: https://docs.metabox.io/tutorials/migrate-data-acf-to-meta-box/
---
...
- [MB Builder](https://metabox.io/plugins/meta-box-builder/): A Meta Box premium extension that provides a UI to create and manage custom fields on the backend;
- [MB ACF Migration](https://metabox.io/plugins/mb-acf-migration/): This extension is also available in the WordPress repo. Besides, if you use Meta Box AIO or Meta Box Core (in the premium bundle), go to **Meta Box** > **Extensions**, and you will see MB ACF Migration in the list. Just tick to enable it.
...
![The created field group](https://imgur.elightup.com/5Wa0fr9.gif%22)
