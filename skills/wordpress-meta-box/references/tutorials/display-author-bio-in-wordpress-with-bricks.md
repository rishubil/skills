...
![move to the Settings tab, set the Location to apply the fields to User](https://imgur.elightup.com/osVTxd8.png)
...
![Choose an icon to display](https://imgur.elightup.com/Z2vIsAy.png)
