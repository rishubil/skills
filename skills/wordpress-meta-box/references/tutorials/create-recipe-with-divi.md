...
![a singular page containing the recipe information as an example](https://imgur.elightup.com/c0SlVLx.png)
...
![Go to Meta Box, Post Types, Add New to create a new one for the recipes](https://imgur.elightup.com/68NYL42.png)

After publishing, you will see a new menu displayed. It's your post type.

![created post type displayed as a menu in admin dashboard](https://imgur.elightup.com/yeD7EOm.png)

## 2\. Creating custom fields

Go to **Meta Box** > **Custom Fields** to create fields to save the recipe information you want.

![Go to Meta Box, Custom Fields to create fields to save the recipe information you want](https://imgur.elightup.com/vvSlGCJ.png)

These are the fields that I created:

![some fields were created as example](https://imgur.elightup.com/agCdHxk.png)
...
![to display the video preview on the frontend, use the oEmbed field for the video instead of the URL field](https://imgur.elightup.com/w4YDjco.png)

Before publishing, move to the **Settings** tab, set the **Location** as **Post Type**, and select **Recipe** to apply these fields to it.

![move to the Settings tab, set the Location as Post Type, and select Recipe to apply these fields to it](https://imgur.elightup.com/Q1Pmm24.png)

Then, in the post editor of the **Recipe** post type, you will see created custom fields.

![created fields in post editor of the Recipe post type](https://imgur.elightup.com/9ZSKr39.png)
...
![Go to Divi, Theme Builder to create a new template for the singular page of each recipe](https://imgur.elightup.com/b6RmIZD.png)

To apply this template for recipes, choose **All Recipes** in the **Template Settings** popup.

![choose All Recipes in the Template Settings popup to apply this template for recipes](https://imgur.elightup.com/Jh6LUqb.png)

Add a row for the first line on the page.

![Add a row for the first line on the page](https://imgur.elightup.com/5tkXUTa.png)

It’s the post title, so search the **Post Title** module.

![It’s the post title, so search the Post Title module](https://imgur.elightup.com/9XjmUzy.png)

For this first section, add a new row. You can choose any layout as you want for this section.

![For this first section, add a new row and choose any layout as you want for this section](https://imgur.elightup.com/qSZZ74k.png)

In the first column, add the **Image** module.

![In the first column, add the Image module](https://imgur.elightup.com/yQJ7wf9.png)

Then click on the **Dynamic Content** icon button.

![click on the Dynamic Content icon button](https://imgur.elightup.com/0aK0Vw2.png)

And choose the **Featured Image** from the dropdown list.

![choose the Featured Image from the dropdown list](https://imgur.elightup.com/8S48T8R.png)

![the image will display like this](https://imgur.elightup.com/3Q7ng4z.png)

Move to the second column, I will display the timing information.

They’re all text, so add the **Text** module.

![add the Text module for the timing information](https://imgur.elightup.com/zUeSoqe.png)

We also use the **Dynamic Content** icon button to get data from custom fields.

![also use the Dynamic Content icon button to get data from custom fields](https://imgur.elightup.com/45peVY7.png)
...
![Since the information is saved in custom fields from Meta Box, find the Meta Box: Recipe Information section, and select the custom field you want](https://imgur.elightup.com/zpYeM2S.png)

You can add the **After text** to have a clearer name the information on the page.

![You can add the After text to have a clearer name the information on the page](https://imgur.elightup.com/heDdmzN.png)
...
![duplicate the Text module for the next three information](https://imgur.elightup.com/ZSWAom5.png)

Then use the dynamic content feature to change and get data from the corresponding field.

![use the dynamic content feature to change and get data from the corresponding field](https://imgur.elightup.com/sPrNQWb.png)

Also rename the after text.

![rename the after text](https://imgur.elightup.com/MWFFEvJ.png)

![The timing information was gotton](https://imgur.elightup.com/KNftdll.png)

Add a new **Row** for the next section.

![Add a new Row for the next section](https://imgur.elightup.com/n1pxPu6.png)

Choose the **Text** module for the name of the section.

![hoose the Text module for the name of the section](https://imgur.elightup.com/07vlGhX.png)
...
![we should use the Meta Box Field module to get the data from the WYSIWYG field instead of using the Text module from Divi as previously](https://imgur.elightup.com/xoTi5fJ.png)
...
![Click on the location to set location for the module](https://imgur.elightup.com/9doKiUg.png)

![choose the field in the dropdown list](https://imgur.elightup.com/isBEN93.png)
...
![add a Text module for the name of instructions section](https://imgur.elightup.com/Z6KHHbn.png)
...
![Go to Divi, Divi Library, Add New to create a new layout for the group](https://imgur.elightup.com/nCapnD8.png)

Set the **Layout Type** as **Section**.

![Set the Layout Type as Section](https://imgur.elightup.com/oNWPoQc.png)

Inside the layout, add the **Meta Box Field** module.

![Inside the layout, add the Meta Box Field module](https://imgur.elightup.com/jI1E72q.png)

And set its location as a subfield of the group to get data from it.

![set its location as a subfield of the group to get data from it](https://imgur.elightup.com/JqsEh3f.png)

![since we have 2 subfields in the group, we need to use 2 Meta Box Field modules](https://imgur.elightup.com/9lEKPpm.png)

Now, back to the page template editor, and add the **Meta Box Cloneable** module.

![back to the page template editor, and add the Meta Box Cloneable module](https://imgur.elightup.com/Pf6yYCB.png)

Set its layout as the one we have just created.

![Set its layout as the one we have just created](https://imgur.elightup.com/rsFdNXT.png)

Also set the **Cloneable Field** as the group.

![set the Cloneable Field as the group](https://imgur.elightup.com/RJIjuEy.png)
...
![For the next, add the Text module for the title](https://imgur.elightup.com/FNl8LAN.png)
...
![we highly recommend using the Meta Box Field module because it can get every kind of data even with the video URL](https://imgur.elightup.com/wLrB4cZ.png)

![Every information is gotton](https://imgur.elightup.com/wM8L5in.png)
...
![on the frontend, all the information is displayed with the right format](https://imgur.elightup.com/9676znI.gif)
...
![To style the page, back to the page template editor, choose each module to change their settings, one by one](https://imgur.elightup.com/eNA21da.png)

I just changed some things basically.

And this is the final look of the page.

![the final look of the page](https://imgur.elightup.com/kHP5gS7.gif)
