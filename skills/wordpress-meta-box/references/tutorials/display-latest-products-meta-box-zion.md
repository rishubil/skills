---
title: Displaying the latest products - Meta Box + Zion - Meta Box Documentation
source: https://docs.metabox.io/tutorials/display-latest-products-meta-box-zion/
version: 5.12.0
fetched: 2026-05-11
---
...
- [MB Builder](https://metabox.io/plugins/meta-box-builder/): to create custom fields for the Restaurant post type in the backend; Zion Builder (Pro version): to build the page.
