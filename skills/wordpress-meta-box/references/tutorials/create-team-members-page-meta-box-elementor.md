...
- [MB Elementor Integration](https://metabox.io/plugins/mb-elementor-integrator/). allows you to get data from custom fields created by the Meta Box plugin in the templates of Elementor.
- [Elementor](https://elementor.com/) (Pro version): to built the page for displaying team members’ information;
- [Elementor Custom Skin](https://wordpress.org/plugins/ele-custom-skin/): to have the Loop template to display the list of posts which are members.
