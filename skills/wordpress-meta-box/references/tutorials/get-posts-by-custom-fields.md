...
## Method 1: Get posts using WP\_Query

To know more about the parameters of which the constructor method WP\_Query accepts, please read [here](https://developer.wordpress.org/reference/classes/wp_query/).
...
## Method 2: Get posts using wp\_postmeta
...
### 1\. Join the wp\_posts and wp\_postmeta tables
