...
Next, we use the `template_redirect` hook to download the ics file (when users click the Add to Calendar button) with the start\_date, end\_date, location, and summary data received above.
