---
title: Creating a custom 404 page in WordPress - Meta Box + Bricks - Meta Box Documentation
source: https://docs.metabox.io/tutorials/create-custom-404-page-with-bricks/
---
