...
![Example of a Product Page](https://imgur.elightup.com/iufdSei.png)
...
![Create a new custom post type](https://imgur.elightup.com/lGQiD5h.png)

After publishing, you will see a new **Car Rentals** menu here.

![New custom post type after created in the admin dash board](https://imgur.elightup.com/eg4njnw.png)
...
![Created custom field](https://imgur.elightup.com/NTX5107.png)

For the car year information, you can give some example data for it by filling in an example year in the **Placeholder** box.

![To give some example data for the field, fill in the Placeholder box](https://imgur.elightup.com/Hq7LjQK.png)

You can also enter numbers in the **Min Value** and **Max Value** boxes in order to limit the numbers of passenger like this:

![Enter numbers in the Min Value and Max Value boxes to limit the number of passengers](https://imgur.elightup.com/ayglK5l.png)
...
![Fill in some options in the Choices box to allow users to choose](https://imgur.elightup.com/PS4WJJ6.png)
...
![Set location in the settings to apply created fields](https://imgur.elightup.com/RosbUB9.png)

You can easily see all the created custom fields when creating a new post in the Car Rentals post type.

![All created custom fields in the created post type](https://imgur.elightup.com/Hw2emW6.png)

## 3\. Creating a template for the page

Go to **Bricks > Template** to create a new template.

![Create a template for the page](https://imgur.elightup.com/UI0YVKU.png)

Since each product is displayed as a single page, set the template as **Single** and then edit it with **Bricks**.

![Set the template as Single](https://imgur.elightup.com/2mCVaEW.png)
...
![Apply the template to the wanted post type](https://imgur.elightup.com/uUtj64h.gif)
...
![Select the content type as a single post](https://imgur.elightup.com/t4i3PSH.png)
...
![Add a Carousel element](https://imgur.elightup.com/tK8mwH0.png)

Then, all the pictures of the products will be shown immediately.

![All the pictures of the products will be shown imediately](https://imgur.elightup.com/zUnzhN1.png)
...
![Add the Post title and post content element](https://imgur.elightup.com/m1eb7NW.png)
...
![Display the rental price per day](https://imgur.elightup.com/54ZOeGo.png)
...
![Add the List element for detailed information](https://imgur.elightup.com/sp1N4Io.png)

Then, still in the list, just add respective items and connect them to the custom fields in the same way.

![Add respective items to the list and connect them to the wanteds custom fields](https://imgur.elightup.com/Hs7YcQD.png)

![Connect them the same way](https://imgur.elightup.com/jWNrKsK.png)
...
![Style the page](https://imgur.elightup.com/hY89Ndj.png)

Here is my product page after styling.

![The final result](https://imgur.elightup.com/iufdSei.png)
