...
![A video gallery created with Meta Box and Kadence](https://imgur.elightup.com/ndXhllO.png)
...
- **Kadence** with **its pro version** to have some extra types of blocks to flexibly display the information.

## 1\. Creating a new post type

Go to **Meta Box** > **Post Types** to create a new post type for the videos.

![Create a new post type for the videos](https://imgur.elightup.com/UrQfdhp.png)
...
![Check the box to enable the author feature](https://imgur.elightup.com/SwVCnfd.png)

After publishing, you will see a new menu displayed. It's your post type.

![A new menu display in the dashboard](https://imgur.elightup.com/jkynIAI.png)

## 2\. Creating a custom field

Move to **Meta Box** > **Custom Fields** > **Add New** to create a new field group.

![Move to Meta Box > Custom Fields > Add New to create a new field group.](https://imgur.elightup.com/lpux754.png)
...
![Choose the oEmbed field to save the video’s link](https://imgur.elightup.com/4QEuhAa.png)
...
![Set location to apply the field to the Video post type](https://imgur.elightup.com/rZ8PqwQ.png)

Now, you’ll see the created custom field in the post editor.

![The created custom field in the post editor](https://imgur.elightup.com/IUxR4z7.png)
...
![The Author box is available since we set it to enable the author feature for the Video post type.](https://imgur.elightup.com/i0PF1yL.png)
...
![Go to Kadence Blocks > All Query Cards and create a new query card](https://imgur.elightup.com/oQJ8ANU.png)

After choosing the wanted layout for the card, you will see some default blog posts displayed.

![After choosing the wanted layout for the card, some default blog posts display.](https://imgur.elightup.com/mKqU2Yj.png)

Go to the right sidebar, set the preview as the post type that we created.

![Set the preview as the post type that we created](https://imgur.elightup.com/hX7gfgm.png)

The preview will change, but please notice that it’s just changing in the preview, not querying any data.

![The preview will change, not querying any data.](https://imgur.elightup.com/F8qs8Wd.gif)
...
![Choose the Dynamic HTML block to have more options to customize the display of the video preview](https://imgur.elightup.com/S6bMTXM.png)

Then, set the **HTML Content** as **Post Custom Field** and select the field of the video.

![Set the HTML Content as Post Custom Field and select the field of the video](https://imgur.elightup.com/Eb8EYl3.png)

Now, you can see the videos displayed immediately.

![The videos display](https://imgur.elightup.com/IEM0UOS.png)

For the additional information of the video, we style it into 2 columns like this:

![2 columns of additional information of the video](https://imgur.elightup.com/vdwxAJL.png)

So, add a **Columns** block, and choose the layout for it.

![Add a Columns block and choose the layout for it](https://imgur.elightup.com/eWcJqMl.png)
...
![Add an Advanced Image block to display the author’s avatar, just enable dynamic image for this block](https://imgur.elightup.com/VfMSt8F.png)

Click on the button as the image below shown, and choose the **Author Image** from the dropdown list.

![Choose the Author Image from the dropdown list](https://imgur.elightup.com/I36XJrC.png)

After that, you will see the author's avatar appear.

![The author's avatar appears.](https://imgur.elightup.com/AgPeACn.png)
...
![Choose a Section block to cover all the rest information and a Text Advanced block to get the name of the video](https://imgur.elightup.com/AKFUqd1.png)

Now, enable dynamic content, and choose the **Post Title** option.

![Enable dynamic content and choose the Post Title option](https://imgur.elightup.com/BgIQUwF.png)

Next, choose the **Author Name** block. The name says it all!

![Choose the Author Name block to get the names of the authors.](https://imgur.elightup.com/GdbvY9Z.png)

For the video’s description, choose the **Dynamic HTML** block again. Then, set the **HTML Content** as **Post Excerpt**.

![For the video’s description, choose the Dynamic HTML block, then set the HTML Content as Post Excerpt.](https://imgur.elightup.com/UyrbM28.png)

And the last information is the published date, choose another **Dynamic HTML** block and connect it to the post date.

![For the published date, choose the Dynamic HTML block and connect it to the post date.](https://imgur.elightup.com/zykh2TG.png)
...
![Change some parameters in each block to have a better look](https://imgur.elightup.com/3QNDH6O.png)
...
![Go to Meta Box > Pages to create a new page](https://imgur.elightup.com/AdWfzmf.png)
...
![Add the Advanced Query Loop block.](https://imgur.elightup.com/qqcP6zv.png)

![Create a new query](https://imgur.elightup.com/8VJXvMU.png)
...
![Choose the post type that we use for the videos.](https://imgur.elightup.com/vu1qwEP.png)
...
![Select the created card for the layout of each video display](https://imgur.elightup.com/5FbM6RX.png)
...
![Change the layout of the gallery by changing some settings](https://imgur.elightup.com/ozrgq5S.png)

You also can use some CSS as well.

![Use some CSS](https://imgur.elightup.com/QIg6mzT.png)

Let’s see how they look on the page!

![The final result of the video gallery](https://imgur.elightup.com/ndXhllO.png)
