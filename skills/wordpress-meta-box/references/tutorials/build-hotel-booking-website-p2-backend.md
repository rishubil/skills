...
When selecting the check-out date, the following code will call the calculate\_total\_day function to calculate the number of nights stayed and assign it to the total\_nights\_of\_stay field.
