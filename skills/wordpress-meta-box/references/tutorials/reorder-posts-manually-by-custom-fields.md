...
These 3 lines arrange your posts in ascending order according to the value of the field with ID **'mb\_order'**. Replace **'mb\_order'** with your field ID if you use another ID.
