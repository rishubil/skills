...
![Install Meta Box Lite to create custom post types and custom taxonomiesMB custom post typed and custom taxonomies plugin](https://imgur.elightup.com/6Kqp8ek.png)
...
![There're two positions you can create a new custom post type](https://imgur.elightup.com/68NYL42.png)
...
![Create a new post type with the name is Project](https://imgur.elightup.com/Ar2uT2I.png)
...
![Options of labels tab are auto-generated on the created post type name](https://imgur.elightup.com/YxfTzn8.png)
...
![To add more advanced information for the post type, go to the Advanced tab](https://imgur.elightup.com/qdHGC1Z.png)
...
![With Show as top-level menu default option, two fields will appear](https://imgur.elightup.com/oXk1z33.png)
...
![Choose options you want](https://imgur.elightup.com/CjAacBI.png)
...
![Choose the options you want](https://imgur.elightup.com/RmnfwHP.png)

- **Show in nav menu**: show the post type section in the menu;

![Choose the screen elements to show](https://imgur.elightup.com/s1XrH8f.png)
...
![Choose the options you want](https://imgur.elightup.com/r1yUpet.png)
...
![Choose more features for the post type](https://imgur.elightup.com/9n9pBqx.png)
...
![Set taxonomies for the post type](https://imgur.elightup.com/KVKwlKK.png)
...
![The created post type will appear in the menu dashboard](https://imgur.elightup.com/g5Nmc9t.png)

## Creating custom taxonomies

Click on the **Create a taxonomy** quick action on the dashboard to move to the Taxonomies submenu.

![Create custom taxonomies](https://imgur.elightup.com/cZrEL4a.png)
...
![Fill in the information of the taxonomy](https://imgur.elightup.com/CohaxS7.png)
...
![Set the options of Labels tab as you want](https://imgur.elightup.com/mmmuYHt.png)
...
![There are some special options for the Advanced tab](https://imgur.elightup.com/2TJyQxr.png)
...
![Choose the options you want](https://imgur.elightup.com/ZgYEVsO.png)
...
![Set post type for the taxonomy](https://imgur.elightup.com/FeGp5qS.png)
