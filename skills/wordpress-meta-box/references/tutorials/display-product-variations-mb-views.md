...
| --- | --- | --- |
| Variations of Product | Group | variations\_of\_product |
| Product Image | Image Advanced | product\_image |
| Size | Checkbox List | size |
| Original Price | Text | original\_price |
| Promotional Price | Text | promotional\_price |
| Status | Select | status |
| Color Name | Select | color\_name |
