...
Then, the voucher\_classes will be assigned for the slug of the term.
...
I’ve uploaded all the code to [GitHub](https://github.com/wpmetabox/tutorials/tree/master/create-a-simple-listing-with-mb-views), so you can refer to it. Now, go to the page on the frontend, and check the filter. It works well.
