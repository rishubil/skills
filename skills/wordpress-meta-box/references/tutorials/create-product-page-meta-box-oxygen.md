...
Enter the name for the post type, and if you want some further configuration, follow [this tutorial](https://docs.metabox.io/tutorials/create-custom-post-type-taxonomies/).
