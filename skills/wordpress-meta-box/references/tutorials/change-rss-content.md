...
Then, go to the RSS file of your site at this address - [http://yourwebsite.com/feed](http://yourwebsite.com/feed). You will see the data from custom fields has been there already.
