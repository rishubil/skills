---
title: Showing the featured restaurants - Meta Box + Elementor - Meta Box Documentation
source: https://docs.metabox.io/tutorials/show-featured-restaurants-with-elementor/
version: 5.12.0
fetched: 2026-05-11
---
...
***my\_custom\_filter*** is the name of the custom query, you can name it as your own.
...
This is the mentioned condition. It means that if the custom field, which has the **ID** as ' ***feature\_the\_restaurant*** ', has the value as 1, the post will be got and displayed. **1** is the value of its **On** status.
