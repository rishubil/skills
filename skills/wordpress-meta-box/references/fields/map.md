...
![The Google Maps field interface](https://imgur.elightup.com/zyKqRTD.png)

The Google Maps field interface

![The map field settings](https://docs.metabox.io/settings/map.png)
