---
title: Taxonomy - Meta Box Documentation
source: https://docs.metabox.io/fields/taxonomy/
---
...
![The taxonomy field default interface](https://imgur.elightup.com/PzPkqur.png)

The taxonomy field default interface

![The taxonomy field with checkbox list interface](https://imgur.elightup.com/Ook0RwT.png)

The taxonomy field with checkbox list interface

![The taxonomy field with checkbox tree interface](https://imgur.elightup.com/iLMFVBY.png)

The taxonomy field with checkbox tree interface

![The taxonomy field with select tree interface](https://imgur.elightup.com/orDECYA.png)

The taxonomy field with select tree interface

![The taxonomy field settings](https://docs.metabox.io/settings/taxonomy.png)

The taxonomy field settings

![The taxonomy field with radio list interface](https://imgur.elightup.com/D7Q5mUA.png)

The taxonomy field with radio list interface

![The taxonomy field with radio list inline interface](https://imgur.elightup.com/XMhMjoN.png)
...
| Query args | `query_args` | Query arguments for getting taxonomy terms. Uses same arguments as [get\_terms()](https://developer.wordpress.org/reference/functions/get_terms/). Optional. |
...
> How to save data
> 
> If you prefer saving data, check out the [taxonomy advanced](https://docs.metabox.io/fields/taxonomy-advanced/) field.
