---
title: Text List - Meta Box Documentation
source: https://docs.metabox.io/fields/text-list/
version: 5.12.0
fetched: 2026-05-11
---
...
![The text list field interface](https://imgur.elightup.com/Y7qo1No.png)

The text list field interface

![The text list field settings](https://docs.metabox.io/settings/text-list.png)
