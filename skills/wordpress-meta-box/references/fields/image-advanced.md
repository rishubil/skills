...
![The image advanced field interface](https://imgur.elightup.com/tzksNdI.png)

The image advanced field interface

![The image advanced field settings](https://docs.metabox.io/settings/image-advanced.png)
