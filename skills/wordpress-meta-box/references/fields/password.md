...
![The password field interface](https://imgur.elightup.com/xozZVMx.png)

The password field interface

![The password field settings](https://docs.metabox.io/settings/password.png)
...
This field saves the encrypted password in the database for better security. The password is encrypted by [wp\_hash\_password()](https://developer.wordpress.org/reference/functions/wp_hash_password/) function.
