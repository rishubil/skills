...
![The background field interface](https://i0.wp.com/images.elightup.com/meta-box/docs/fields/icon/screenshot.png)

The background field interface

![The icon field settings](https://docs.metabox.io/settings/icon.png)
...
[
    ...
    'icon_css'  => 'https://unpkg.com/[email protected]/css/boxicons.min.css', // Boxicon CDN.
]
```
