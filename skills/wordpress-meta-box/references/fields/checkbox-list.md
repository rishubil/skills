...
![Checkbox list vertical with "Toggle All" button](https://docs.metabox.io/screenshots/checkbox-list-1.png)

Checkbox list vertical with "Toggle All" button

![Checkbox list inline](https://docs.metabox.io/screenshots/checkbox-list-2.png)

Checkbox list inline

![The checkbox list field settings](https://docs.metabox.io/settings/checkbox-list.png)
...
![Input the label of the options in the Choices box](https://docs.metabox.io/assets/images/choices-34a792e310d46c7b4534f84ef52f5a1c.png)
...
![the field with settings and options](https://docs.metabox.io/assets/images/value-label-a678854e55ada523294ff670080dfa27.png)
