...
![Radio choices inline](https://docs.metabox.io/screenshots/radio-1.png)

Radio choices inline

![Radio choices on multiple lines](https://docs.metabox.io/screenshots/radio-2.png)

Radio choices on multiple lines

![The radio field settings](https://docs.metabox.io/settings/radio.png)
