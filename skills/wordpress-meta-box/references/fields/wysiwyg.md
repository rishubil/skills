...
![The WYSIWYG field interface](https://imgur.elightup.com/Y72Bcvw.png)

The WYSIWYG field interface

![The wysiwyg field settings](https://docs.metabox.io/settings/wysiwyg.png)
