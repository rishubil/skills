...
![The fieldset text field interface](https://imgur.elightup.com/qh3pfUd.png)

The fieldset text field interface

![The fieldset text field settings](https://docs.metabox.io/settings/fieldset-text.png)
