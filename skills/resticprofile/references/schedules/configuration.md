---
title: Schedule Configuration :: resticprofile
source: https://creativeprojects.github.io/resticprofile/schedules/configuration/
---
...
When `schedule-permission` is set to `user_logged_on`, Windows Task Scheduler runs tasks in the foreground. This behavior may interrupt the user’s activity and is often undesirable.
