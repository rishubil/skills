---
title: Systemd :: resticprofile
source: https://creativeprojects.github.io/resticprofile/schedules/systemd/
---
...
| **user\_logged\_on** | user service | runs only when user is logged on | can run any time | no |
...
You can automatically populate `*.conf.d` [drop-in files](https://www.freedesktop.org/software/systemd/man/latest/systemd-system.conf.html#main-conf) for profiles, allowing easy overrides of generated services without [modifying service templates](https://creativeprojects.github.io/resticprofile/schedules/systemd/index.html#how-to-change-the-default-systemd-unit-and-timer-file-using-a-template). For example:
