---
title: HTTP Hooks :: resticprofile
source: https://creativeprojects.github.io/resticprofile/configuration/http_hooks/
---
...
As well as being able to run [shell commands](https://creativeprojects.github.io/resticprofile/configuration/run_hooks/index.html), you can now send HTTP messages before, after (success or failure) running a restic command.
