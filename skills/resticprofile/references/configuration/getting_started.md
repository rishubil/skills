---
title: Getting Started :: resticprofile
source: https://creativeprojects.github.io/resticprofile/configuration/getting_started/
---
...
Unless you’re using the **resticprofile** [Docker image](https://creativeprojects.github.io/resticprofile/installation/docker/index.html), you need to have **restic** [installed on your machine](https://restic.readthedocs.io/en/stable/).
...
You can use any other editor that recognizes the [JSON schema](https://creativeprojects.github.io/resticprofile/configuration/jsonschema/index.html). The same JSON schema can be used for JSON, TOML, and YAML file formats.
...
[![TOML extension](https://creativeprojects.github.io/resticprofile/configuration/getting_started/TOML.png)](#R-image-516b3d210271df36406a1dce360bd795) ![TOML extension](https://creativeprojects.github.io/resticprofile/configuration/getting_started/TOML.png)
...
[![YAML extension](https://creativeprojects.github.io/resticprofile/configuration/getting_started/YAML.png)](#R-image-ba37d2bd56a6e8f82ec2a60936b57f50) ![YAML extension](https://creativeprojects.github.io/resticprofile/configuration/getting_started/YAML.png)
...
**resticprofile** can generate a [secure password file](https://creativeprojects.github.io/resticprofile/usage/keyfile/index.html) for you:
...
**resticprofile** can [schedule](https://creativeprojects.github.io/resticprofile/schedules/index.html) work on macOS, Windows, most Unixes and Linux distributions: it is simply adding an entry in the default scheduler of your platform.
