---
title: Path :: resticprofile
source: https://creativeprojects.github.io/resticprofile/configuration/path/
---
...
These paths may be overridden by setting the `XDG_CONFIG_HOME` or `XDG_CONFIG_DIRS` environment variables.