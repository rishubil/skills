---
title: options :: resticprofile
source: https://creativeprojects.github.io/resticprofile/reference/profile/options/
---
...
This section configures restic command `options` available since `0.18.0`. Information on command and flags is copied from the [restic](https://github.com/restic/restic) manual pages.
