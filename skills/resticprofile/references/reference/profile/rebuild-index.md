---
title: rebuild-index :: resticprofile
source: https://creativeprojects.github.io/resticprofile/reference/profile/rebuild-index/
---
...
This section configures restic command `rebuild-index` removed in `0.16.0`. Information on command and flags is copied from the [restic](https://github.com/restic/restic) manual pages.
