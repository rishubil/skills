...
[Application.AudioContentProviderApp](https://developer.garmin.com/connect-iq/api-docs/Toybox/Application/AudioContentProviderApp.html)
...
- [**allowTrialMessage**](#allowTrialMessage-instance_function "allowTrialMessage (Instance Function)") () as [Lang.Boolean](https://developer.garmin.com/connect-iq/api-docs/Toybox/Lang/Boolean.html)
...
- [**deleteProperty**](#deleteProperty-instance_function "deleteProperty (Instance Function)") (key as [Application.PropertyKeyType](https://developer.garmin.com/connect-iq/api-docs/Toybox/Application.html#PropertyKeyType-named_type)) as **Void** deprecated
	Delete the given key from the object store.
- [**getGlanceTheme**](#getGlanceTheme-instance_function "getGlanceTheme (Instance Function)") () as [AppBase.GlanceTheme](https://developer.garmin.com/connect-iq/api-docs/Toybox/Application/AppBase.html#GlanceTheme-module)
	Method to get the glance theme.
- [**getGlanceView**](#getGlanceView-instance_function "getGlanceView (Instance Function)") () as \[ [WatchUi.GlanceView](https://developer.garmin.com/connect-iq/api-docs/Toybox/WatchUi/GlanceView.html) \] or \[ [WatchUi.GlanceView](https://developer.garmin.com/connect-iq/api-docs/Toybox/WatchUi/GlanceView.html), [WatchUi.GlanceViewDelegate](https://developer.garmin.com/connect-iq/api-docs/Toybox/WatchUi/GlanceViewDelegate.html) \] or **Null**
	Override to provide the [WatchUi.GlanceView](https://developer.garmin.com/connect-iq/api-docs/Toybox/WatchUi/GlanceView.html) and [WatchUi.GlanceViewDelegate](https://developer.garmin.com/connect-iq/api-docs/Toybox/WatchUi/GlanceViewDelegate.html) for the glance preview.
- [**getGoalView**](#getGoalView-instance_function "getGoalView (Instance Function)") (goalType as [Application.GoalType](https://developer.garmin.com/connect-iq/api-docs/Toybox/Application.html#GoalType-module)) as \[ [WatchUi.View](https://developer.garmin.com/connect-iq/api-docs/Toybox/WatchUi/View.html) \] or **Null**
	Override to provide a [WatchUi.View](https://developer.garmin.com/connect-iq/api-docs/Toybox/WatchUi/View.html) for a goal that has triggered within a watch face.
- [**getInitialView**](#getInitialView-instance_function "getInitialView (Instance Function)") () as \[ [WatchUi.Views](https://developer.garmin.com/connect-iq/api-docs/Toybox/WatchUi.html#Views-named_type) \] or \[ [WatchUi.Views](https://developer.garmin.com/connect-iq/api-docs/Toybox/WatchUi.html#Views-named_type), [WatchUi.InputDelegates](https://developer.garmin.com/connect-iq/api-docs/Toybox/WatchUi.html#InputDelegates-named_type) \]
	Override to provide the initial View and Input Delegate of the application.
- [**getProperty**](#getProperty-instance_function "getProperty (Instance Function)") (key as [Application.PropertyKeyType](https://developer.garmin.com/connect-iq/api-docs/Toybox/Application.html#PropertyKeyType-named_type)) as [Application.PropertyValueType](https://developer.garmin.com/connect-iq/api-docs/Toybox/Application.html#PropertyValueType-named_type) deprecated
	Get the data associated with a given key from the object store.
- [**getSensorConfigurationView**](#getSensorConfigurationView-instance_function "getSensorConfigurationView (Instance Function)") (sensor as [Sensor.SensorInfo](https://developer.garmin.com/connect-iq/api-docs/Toybox/Sensor/SensorInfo.html)) as \[ [WatchUi.Views](https://developer.garmin.com/connect-iq/api-docs/Toybox/WatchUi.html#Views-named_type) \] or \[ [WatchUi.Views](https://developer.garmin.com/connect-iq/api-docs/Toybox/WatchUi.html#Views-named_type), [WatchUi.InputDelegates](https://developer.garmin.com/connect-iq/api-docs/Toybox/WatchUi.html#InputDelegates-named_type) \]
	Override to provide the pairing config View and Input Delegate of the application.
- [**getSensorDelegate**](#getSensorDelegate-instance_function "getSensorDelegate (Instance Function)") () as [Sensor.SensorDelegate](https://developer.garmin.com/connect-iq/api-docs/Toybox/Sensor/SensorDelegate.html) or **Null**
	Override to provide the Sensor Delegate object.
- [**getServiceDelegate**](#getServiceDelegate-instance_function "getServiceDelegate (Instance Function)") () as \[ [System.ServiceDelegate](https://developer.garmin.com/connect-iq/api-docs/Toybox/System/ServiceDelegate.html) \]
	Get a [ServiceDelegate](https://developer.garmin.com/connect-iq/api-docs/Toybox/System/ServiceDelegate.html) to run background tasks for this app.
- [**getSettingsView**](#getSettingsView-instance_function "getSettingsView (Instance Function)") () as \[ [WatchUi.Views](https://developer.garmin.com/connect-iq/api-docs/Toybox/WatchUi.html#Views-named_type) \] or \[ [WatchUi.Views](https://developer.garmin.com/connect-iq/api-docs/Toybox/WatchUi.html#Views-named_type), [WatchUi.InputDelegates](https://developer.garmin.com/connect-iq/api-docs/Toybox/WatchUi.html#InputDelegates-named_type) \] or **Null**
	Override to provide the settings View and Input Delegate of the application.
- [**getSyncDelegate**](#getSyncDelegate-instance_function "getSyncDelegate (Instance Function)") () as [Communications.SyncDelegate](https://developer.garmin.com/connect-iq/api-docs/Toybox/Communications/SyncDelegate.html) or **Null**
	Get a [SyncDelegate](https://developer.garmin.com/connect-iq/api-docs/Toybox/Communications/SyncDelegate.html) object that communicates sync status to the system for syncing content to the device.
- [**getTrialDaysRemaining**](#getTrialDaysRemaining-instance_function "getTrialDaysRemaining (Instance Function)") () as [Lang.Number](https://developer.garmin.com/connect-iq/api-docs/Toybox/Lang/Number.html) or **Null**
...
- [**isActive**](#isActive-instance_function "isActive (Instance Function)") () as [Lang.Boolean](https://developer.garmin.com/connect-iq/api-docs/Toybox/Lang/Boolean.html)
	return true if app is currently in active state, otherwise false.
- [**isTrial**](#isTrial-instance_function "isTrial (Instance Function)") () as [Lang.Boolean](https://developer.garmin.com/connect-iq/api-docs/Toybox/Lang/Boolean.html)
...
- [**onActive**](#onActive-instance_function "onActive (Instance Function)") (state as [Lang.Dictionary](https://developer.garmin.com/connect-iq/api-docs/Toybox/Lang/Dictionary.html) or **Null**) as **Void**
...
- [**onBackgroundData**](#onBackgroundData-instance_function "onBackgroundData (Instance Function)") (data as [Application.PersistableType](https://developer.garmin.com/connect-iq/api-docs/Toybox/Application.html#PersistableType-named_type)) as **Void**
	Handle data passed from a ServiceDelegate to the application.
- [**onDeviceSettingChanged**](#onDeviceSettingChanged-instance_function "onDeviceSettingChanged (Instance Function)") (aSymbol as [Lang.Symbol](https://developer.garmin.com/connect-iq/api-docs/Toybox/Lang/Symbol.html), aValue as [Lang.Object](https://developer.garmin.com/connect-iq/api-docs/Toybox/Lang/Object.html)) as **Void**
...
- [**onInactive**](#onInactive-instance_function "onInactive (Instance Function)") (state as [Lang.Dictionary](https://developer.garmin.com/connect-iq/api-docs/Toybox/Lang/Dictionary.html) or **Null**) as **Void**
...
- [**onStart**](#onStart-instance_function "onStart (Instance Function)") (state as [Lang.Dictionary](https://developer.garmin.com/connect-iq/api-docs/Toybox/Lang/Dictionary.html) or **Null**) as **Void**
	Method called at startup to allow handling of app initialization.
- [**onStop**](#onStop-instance_function "onStop (Instance Function)") (state as [Lang.Dictionary](https://developer.garmin.com/connect-iq/api-docs/Toybox/Lang/Dictionary.html) or **Null**) as **Void**
...
- [**onValidateProperty**](#onValidateProperty-instance_function "onValidateProperty (Instance Function)") (key as [Lang.String](https://developer.garmin.com/connect-iq/api-docs/Toybox/Lang/String.html), value as [Properties.ValueType](https://developer.garmin.com/connect-iq/api-docs/Toybox/Application/Properties.html#ValueType-named_type)) as [Lang.Boolean](https://developer.garmin.com/connect-iq/api-docs/Toybox/Lang/Boolean.html) or [Lang.String](https://developer.garmin.com/connect-iq/api-docs/Toybox/Lang/String.html)
...
- [**setProperty**](#setProperty-instance_function "setProperty (Instance Function)") (key as [Application.PropertyKeyType](https://developer.garmin.com/connect-iq/api-docs/Toybox/Application.html#PropertyKeyType-named_type), value as [Application.PropertyValueType](https://developer.garmin.com/connect-iq/api-docs/Toybox/Application.html#PropertyValueType-named_type)) as **Void** deprecated
	Store the given data in the object.
- [**validateProperty**](#validateProperty-instance_function "validateProperty (Instance Function)") (key as [Application.PropertyKeyType](https://developer.garmin.com/connect-iq/api-docs/Toybox/Application.html#PropertyKeyType-named_type), value as [Application.PropertyValueType](https://developer.garmin.com/connect-iq/api-docs/Toybox/Application.html#PropertyValueType-named_type)) as **Void**
