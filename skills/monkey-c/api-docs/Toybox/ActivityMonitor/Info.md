...
- [**activeMinutesDay**](#activeMinutesDay-var "activeMinutesDay (Var)") as [ActivityMonitor.ActiveMinutes](https://developer.garmin.com/connect-iq/api-docs/Toybox/ActivityMonitor/ActiveMinutes.html) or **Null**
	The number of active minutes for the current day.
- [**activeMinutesWeek**](#activeMinutesWeek-var "activeMinutesWeek (Var)") as [ActivityMonitor.ActiveMinutes](https://developer.garmin.com/connect-iq/api-docs/Toybox/ActivityMonitor/ActiveMinutes.html) or **Null**
	The number of active minutes for the current week.
- [**activeMinutesWeekGoal**](#activeMinutesWeekGoal-var "activeMinutesWeekGoal (Var)") as [Lang.Number](https://developer.garmin.com/connect-iq/api-docs/Toybox/Lang/Number.html) or **Null**
...
- [**isSleepMode**](#isSleepMode-var "isSleepMode (Var)") as [Lang.Boolean](https://developer.garmin.com/connect-iq/api-docs/Toybox/Lang/Boolean.html) or **Null** deprecated
	Determine whether the device is in sleep mode.
- [**metersClimbed**](#metersClimbed-var "metersClimbed (Var)") as [Lang.Float](https://developer.garmin.com/connect-iq/api-docs/Toybox/Lang/Float.html) or **Null**
	The vertical distance of floors climbed in meters (m).
- [**metersDescended**](#metersDescended-var "metersDescended (Var)") as [Lang.Float](https://developer.garmin.com/connect-iq/api-docs/Toybox/Lang/Float.html) or **Null**
	The vertical distance of floors descended in meters (m).
- [**moveBarLevel**](#moveBarLevel-var "moveBarLevel (Var)") as [Lang.Number](https://developer.garmin.com/connect-iq/api-docs/Toybox/Lang/Number.html) or **Null**
	The current level of the move bar between [MOVE\_BAR\_LEVEL\_MIN](https://developer.garmin.com/connect-iq/api-docs/Toybox/ActivityMonitor.html#MOVE_BAR_LEVEL_MIN-const) and [MOVE\_BAR\_LEVEL\_MAX](https://developer.garmin.com/connect-iq/api-docs/Toybox/ActivityMonitor.html#MOVE_BAR_LEVEL_MAX-const).
...
- [**respirationRate**](#respirationRate-var "respirationRate (Var)") as [Lang.Number](https://developer.garmin.com/connect-iq/api-docs/Toybox/Lang/Number.html) or **Null**
...
- [**stressScore**](#stressScore-var "stressScore (Var)") as [Lang.Number](https://developer.garmin.com/connect-iq/api-docs/Toybox/Lang/Number.html) or **Null**
...
- [**timeToRecovery**](#timeToRecovery-var "timeToRecovery (Var)") as [Lang.Number](https://developer.garmin.com/connect-iq/api-docs/Toybox/Lang/Number.html) or **Null**
