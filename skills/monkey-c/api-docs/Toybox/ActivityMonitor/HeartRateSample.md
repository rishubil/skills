...
Before using heart rate information, check for [INVALID\_HR\_SAMPLE](https://developer.garmin.com/connect-iq/api-docs/Toybox/ActivityMonitor.html#INVALID_HR_SAMPLE-const) to be sure data is available.
