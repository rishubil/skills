...
[Sensor.Info](https://developer.garmin.com/connect-iq/api-docs/Toybox/Sensor/Info.html) can be retrieved on every call of [onUpdate()](https://developer.garmin.com/connect-iq/api-docs/Toybox/WatchUi/View.html#onUpdate-instance_function) or it can be obtained on demand. Fields in this class may return `null` so should be checked for `null` values prior to use.

## Instance Member Summary

- [**accel**](#accel-var "accel (Var)") as [Lang.Array](https://developer.garmin.com/connect-iq/api-docs/Toybox/Lang/Array.html) < [Lang.Number](https://developer.garmin.com/connect-iq/api-docs/Toybox/Lang/Number.html) > or **Null**
	The accelerometer reading of the x, y, and z axes as an Array of [Number](https://developer.garmin.com/connect-iq/api-docs/Toybox/Lang/Number.html) values in millig-units.
...
- [**heartRate**](#heartRate-var "heartRate (Var)") as [Lang.Number](https://developer.garmin.com/connect-iq/api-docs/Toybox/Lang/Number.html) or **Null**
	The heart rate in beats per minute (bpm).
- [**mag**](#mag-var "mag (Var)") as [Lang.Array](https://developer.garmin.com/connect-iq/api-docs/Toybox/Lang/Array.html) < [Lang.Number](https://developer.garmin.com/connect-iq/api-docs/Toybox/Lang/Number.html) > or **Null**
	The magnetometer reading of the x, y, and z axes as an Array of [Number](https://developer.garmin.com/connect-iq/api-docs/Toybox/Lang/Number.html) values in milliGauss (mG).
- [**oxygenSaturation**](#oxygenSaturation-var "oxygenSaturation (Var)") as [Lang.Number](https://developer.garmin.com/connect-iq/api-docs/Toybox/Lang/Number.html) or **Null**
	The current oxygen saturation in percent (%).
- [**power**](#power-var "power (Var)") as [Lang.Number](https://developer.garmin.com/connect-iq/api-docs/Toybox/Lang/Number.html) or **Null**
	The power in Watts (W).
- [**pressure**](#pressure-var "pressure (Var)") as [Lang.Float](https://developer.garmin.com/connect-iq/api-docs/Toybox/Lang/Float.html) or **Null**
...
- [**temperature**](#temperature-var "temperature (Var)") as [Lang.Float](https://developer.garmin.com/connect-iq/api-docs/Toybox/Lang/Float.html) or **Null**
