...
**Classes:** [BurstListener](Ant/BurstListener.md), [BurstPayload](Ant/BurstPayload.md), [BurstPayloadIterator](Ant/BurstPayloadIterator.md), [ChannelAssignment](Ant/ChannelAssignment.md), [CryptoConfig](Ant/CryptoConfig.md), [DeviceConfig](Ant/DeviceConfig.md), [EncryptionInvalidSettingsException](Ant/EncryptionInvalidSettingsException.md), [GenericChannel](Ant/GenericChannel.md), [Message](Ant/Message.md), [UnableToAcquireChannelException](Ant/UnableToAcquireChannelException.md), [UnableToAcquireEncryptedChannelException](Ant/UnableToAcquireEncryptedChannelException.md)
