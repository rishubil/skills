...
![The post field default interface](https://imgur.elightup.com/jV4d0TW.png)

The post field default interface

![The post field with checkbox list interface](https://imgur.elightup.com/kWVBpgr.png)

The post field with checkbox list interface

![The post field with radio list interface](https://imgur.elightup.com/Vq8VNuD.png)

The post field with radio list interface

![The post field settings](https://docs.metabox.io/settings/post.png)
...
| Query args | `query_args` | Query arguments for getting post objects. Uses the same arguments as [WP\_Query](https://developer.wordpress.org/reference/classes/wp_query/#parameters). Optional. |
