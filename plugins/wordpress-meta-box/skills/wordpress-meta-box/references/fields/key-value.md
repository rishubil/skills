---
title: Key Value - Meta Box Documentation
source: https://docs.metabox.io/fields/key-value/
version: 5.12.0
fetched: 2026-05-11
---
...
![The key value field interface](https://imgur.elightup.com/yA7rRDR.png)

The key value field interface

![The key value field settings](https://docs.metabox.io/settings/key-value.png)
