---
title: Moving custom fields' data to custom tables - Meta Box Documentation
...
- [MB Custom Table](https://metabox.io/plugins/mb-custom-table/) allows saving custom fields' data in a custom table.
- [MB Builder](https://metabox.io/plugins/meta-box-builder/) to have an UI in the back-end to create custom fields for the post type.
...
This script will run when you access the URL *[https://yourwebsite.com/wp-admin/?move-data-companies=1](https://yourwebsite.com/wp-admin/?move-data-companies=1)* It's a URL to your WordPress backend, here we use a custom URL parameter `move-data-companies` to let the script know how to process the data.
...
After adding code, go to this URL: *[https://yourwebsite.com/wp-admin/?move-data-companies=1](https://yourwebsite.com/wp-admin/?move-data-companies=1)* to enable moving the custom fields' data to the custom table.
