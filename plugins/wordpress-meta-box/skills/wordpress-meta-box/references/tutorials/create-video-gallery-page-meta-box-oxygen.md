...
![The example of creating a video gallery page with Meta Box and Oxygen](https://imgur.elightup.com/xg6ygqB.png)
...
![Places to save the video's information](https://imgur.elightup.com/yBa2unw.png)
...
![Create a new custom post type for videos](https://imgur.elightup.com/Ddma0xi.png)

In the settings of the post type, we have the **Support** tab that provides some features to add to your post type. In this case, we will display the author’s information for this post, so check the **Author** box here. ![In the settings of the post type, choose some features of the Supports tab to add them to the post type](https://imgur.elightup.com/qSceLhJ.png)
...
![Choose oEmbed fields that allow you to save the link and display it as the video preview on the frontend](https://imgur.elightup.com/3Q52CkV.png)
...
![In the Settings tab, set the Location as the Video Post Type to apply the created field to this post type](https://imgur.elightup.com/yh6aob5.png)

Then, in the post editor, you will see the newly created custom field.

![In the Post Editor, you will see the created custom field](https://imgur.elightup.com/FM7J0e6.png)
...
![As we added the Author feature in the Supports tab, we will have the Author section to choose the post’s author](https://imgur.elightup.com/UkjEHH1.png)
...
![Get the title of the video gallery page automatically](https://imgur.elightup.com/gR1Xwe8.gif)

Then, add a **Section** component to display the video gallery.

![Add a Section component to display the video gallery](https://imgur.elightup.com/ajscNU2.png)
...
![Inside the Section component, add a Repeater component and set a data source for it](https://imgur.elightup.com/MVf3BNJ.gif)
...
![To get the wanted video preview, we need to change the URL in Dynamic tag](https://imgur.elightup.com/7rgAiUf.png)

Click the **Data** button. Then, in the **Meta/Custom Field** section, find the field’s ID that you saved the video’s link.

![Get the wanted video preview step by step](https://imgur.elightup.com/8SXcNPn.gif)
...
![After adding all the wanted components, you will see all the video’s information displayed](https://imgur.elightup.com/cZ453jD.png)

After saving the template, you will see the video gallery on the page.

![The video gallery on the page before styling](https://imgur.elightup.com/5py7iGN.png)
...
![Change the layout of the gallery in the settings](https://imgur.elightup.com/9a01tAh.png)
...
![Use some CSS codes to style the video gallery page](https://imgur.elightup.com/9cX1mYv.png)
...
![The video gallery page have a new look after styling](https://imgur.elightup.com/xg6ygqB.png)
