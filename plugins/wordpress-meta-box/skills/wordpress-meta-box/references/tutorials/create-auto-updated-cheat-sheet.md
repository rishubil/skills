...
| --- | --- | --- |
| Your Product Name | post\_title | text |
| Your Product Type | product\_type | select\_advanced |
| Your Offer | offer | text |
| Start Date | start\_date | date |
| End Date | end\_date | date |
| Promotion Code | promotion\_code | text |
