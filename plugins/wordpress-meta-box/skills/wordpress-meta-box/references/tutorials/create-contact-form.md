...
In the event that you want the name filled in the field to be the title of the post, you should replace the **ID** of this field to *post\_title*.
...
' *[\[email protected\]](https://docs.metabox.io/cdn-cgi/l/email-protection#d9b8bdb4b0b799bdb6b4b8b0b7f7bab6b4)* ' is the receiver's address who will receive all the notifications about every submission. It should be the email of the admin or anyone who manages the contacts.
