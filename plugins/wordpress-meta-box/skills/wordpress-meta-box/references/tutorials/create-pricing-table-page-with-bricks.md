...
![Go to Pages, and create a new](https://imgur.elightup.com/q31dcJ9.png)
...
![Go to Meta Box, Custom Fields, and create a new field group](https://imgur.elightup.com/7kS269f.png)

First, add a **Group** field.

![Add a Group field](https://imgur.elightup.com/fOnqj7c.png)

Inside the group, add subfields following the structure you want.

![Inside the group, add subfields following the structure you want](https://imgur.elightup.com/4Uh8T45.png)

For the features, I also put them into a group for easier management. So, add a **Group** field as well.

![Add a Group field for the features](https://imgur.elightup.com/lBYRs4Y.png)

Also, add a subfield for it.

![Add subfield for the group of the features](https://imgur.elightup.com/hxPNqNA.png)

I set it collapsible, and set the title for the group as well. In this case, I simply set it based on the order number.

![Set the group as collapsible and set the group titile](https://imgur.elightup.com/opNxQoc.png)

Since each plan has more than one feature, I set this subgroup as cloneable to add more items.

![Set this subgroup as cloneable to add more items](https://imgur.elightup.com/iyKBCLq.png)

And add two fields for the label and URL of the button.

![Add fields for the labels and URLs of the buttons](https://imgur.elightup.com/6FsTWnU.png)
...
![Set the group of the plan as colapsibale and set the group title](https://imgur.elightup.com/Nlmz2er.png)

As well, make the group of the plans cloneable to add more than one plan on your pricing table page.

![Make this group cloneable to add more than one plan](https://imgur.elightup.com/L6yqLkA.png)
...
![Set location for the field group](https://imgur.elightup.com/PXPRMuW.png)

Then, in the page editor, you will see all of the custom fields.

![The custom fields display in the post editor](https://imgur.elightup.com/56haRUD.png)

Just enter information for each plan, and click on the **\+ Add more** button to add other plans.

![Click on the + Add more button to add other plans](https://imgur.elightup.com/9HAgEUZ.png)
...
![Add a Section element to cover all the content of the page](https://imgur.elightup.com/evv3EVn.png)

Since our information is saved in a cloneable group, we need a **Div** element first.

![Add div element for cloneable group](https://imgur.elightup.com/BvWF5KN.png)
...
![Get data source for the div.](https://imgur.elightup.com/t32eBqn.png)
...
![Get the plan’s name](https://imgur.elightup.com/fs979go.png)

Now, you can see that the plans’ names have just been displayed.

![You can see that the plans’ names have just been displayed.](https://imgur.elightup.com/QlU1dfp.png)
...
![Get the plan’s price](https://imgur.elightup.com/4J49q3l.png)
...
![Display the features of each plan](https://imgur.elightup.com/NuH5IjF.png)
...
![Choose icon for feature.](https://imgur.elightup.com/frE9nQq.png)

Move to the **Content** section, use the **Dynamic data** again, and choose the corresponding field to get the feature data.

![get the feature data](https://imgur.elightup.com/tnkuoul.png)
...
![Display the button without any function.](https://imgur.elightup.com/Job3rDi.png)
...
![Get the link for the button](https://imgur.elightup.com/soVuG1l.png)

We have done getting all the information of the pricing table page.

![a simple list of detail](https://imgur.elightup.com/7s3ON2R.png)
...
![Customize each element to style them in your own way with Bricks](https://imgur.elightup.com/IywaIaz.png)
...
![Add classes for styling](https://imgur.elightup.com/s3BlbnU.png)
...
![In the CSS box, add some codes.](https://imgur.elightup.com/SeL0uyy.png)
