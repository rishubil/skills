---
title: Toybox.Weather.CurrentConditions
source: https://developer.garmin.com/connect-iq/api-docs/Toybox/Weather/CurrentConditions.html
---
...
- [**condition**](#condition-var "condition (Var)") as [Lang.Number](../Lang/Number.md) or **Null**
	The current weather condition.
- [**dewPoint**](#dewPoint-var "dewPoint (Var)") as [Lang.Float](../Lang/Float.md) or **Null**
	The dew point in Celsius.
- [**feelsLikeTemperature**](#feelsLikeTemperature-var "feelsLikeTemperature (Var)") as [Lang.Float](../Lang/Float.md) or **Null**
	The wind chill or heat index, in Celsius.
- [**highTemperature**](#highTemperature-var "highTemperature (Var)") as [Lang.Numeric](../Lang.md#Numeric-named_type) or **Null**
	The forecasted high temperature for the day in Celsius.
- [**lowTemperature**](#lowTemperature-var "lowTemperature (Var)") as [Lang.Numeric](../Lang.md#Numeric-named_type) or **Null**
	The forecasted low temperature for the day in Celsius.
- [**observationLocationName**](#observationLocationName-var "observationLocationName (Var)") as [Lang.String](../Lang/String.md) or **Null** deprecated
	Textual description of the observation location.
- [**observationLocationPosition**](#observationLocationPosition-var "observationLocationPosition (Var)") as [Position.Location](../Position/Location.md) or **Null**
	Location where the conditions were observed.
- [**observationTime**](#observationTime-var "observationTime (Var)") as [Time.Moment](../Time/Moment.md) or **Null**
...
- [**uvIndex**](#uvIndex-var "uvIndex (Var)") as [Lang.Float](../Lang/Float.md) or **Null**
	The UV index \[0-10\].
- [**visibility**](#visibility-var "visibility (Var)") as [Lang.Float](../Lang/Float.md) or **Null**
