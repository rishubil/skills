---
title: Prometheus :: resticprofile
source: https://creativeprojects.github.io/resticprofile/monitoring/prometheus/
---
...
Set `extended-status` to `true` to access all available metrics. For details, see [Extended status](https://creativeprojects.github.io/resticprofile/monitoring/status/index.html#-extended-status).
