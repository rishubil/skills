---
title: Schedule Commands :: resticprofile
source: https://creativeprojects.github.io/resticprofile/schedules/commands/
---
...
The `status` command output varies by OS. See the [examples](https://creativeprojects.github.io/resticprofile/schedules/examples/index.html) for details.
